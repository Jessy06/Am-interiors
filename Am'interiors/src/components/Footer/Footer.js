  ...
  return (
    ...
    <div class="sm:flex sm:items-center">
        ...
        <div class="flex mt-10 space-x-10 sm:justify-center sm:mt-0">     
            <a href="https://www.instagram.com/studio.am.interior/" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-gray-900 dark:hover:text-orange-800">
