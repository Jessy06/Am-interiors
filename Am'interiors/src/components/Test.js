...
export default function Modal() {
  ...
  return (
    ...
    {/* <img src="/gfg.png" /> */}
        ...
        <div className="p-1 pl-1 pr-1 mb-1 mt-1 pb-1"></div>
        <input type="text" value={surname} required onChange={(e)  => {handleChange(e)}} /><br/>
          { /*when user write in name input box , handleChange()
              function will be called. */}
        ...
        <input type="texterea" value={texterea} required onChange={(e)  => {handleTextereaChange (e)}} /><br/><br/>
