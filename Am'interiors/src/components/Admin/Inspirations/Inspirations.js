  ...
  return (
    <div>
      ...
      >
        ...
        pour certains de mes projets. L’inspiration vient toujours de partout,
        ça peut autant venir d’une vitrine de boutique de déco devant laquelle
        on passe, que d’une personne qu’on croise dans la rue et qui porte des
        vêtements dont l’association de couleurs fixe le regard, l’inspiration
        vient toujours de quelque chose qui interpelle , mais évidemment tout ça
        inspire parce qu’on cherche l’inspiration, c’est non stop , la recherche
        d’inspiration est en quelque sorte un mode de vie, ça ne s’arrête
        jamais, ça ne prend pas de vacances, mon smartphone et mon bloc notes ne
        me quittent jamais, car c’est grâce a eux que je capte ce qui me plait
        et que je note ce que je n’ai pas envie d’oublier.
        </span>
      </div>
      <br></br>
      <hr></hr>
